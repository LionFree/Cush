...
namespace Cush.Common.FileHandling
{
    public abstract class FileOperator
    {
        ...
        public T Read<T>(string filePath, ProgressChangedEventHandler callback = null)
        {
            ...
            try
            {
                ...
                var input = Deserialize<T>(filePath, callback);
        ...
        /// <param name="callback">A <see cref="ProgressChangedEventHandler" /> callback that will update, e.g., a progress bar.</param>
        /// <returns></returns>
        public bool Write<T>(T array, string filePath, ProgressChangedEventHandler callback = null)
        {
        ...
        /// <param name="callback">A <see cref="ProgressChangedEventHandler" /> callback that will update, e.g., a progress bar.</param>
        /// <returns></returns>
        protected abstract void Serialize<T>(T obj, string filePath, ProgressChangedEventHandler callback);
        ...
        /// <param name="callback">A <see cref="ProgressChangedEventHandler" /> callback that will update, e.g., a progress bar.</param>
        /// <returns>A data object of type T containing the data from the file.</returns>
        protected abstract T Deserialize<T>(string filePath, ProgressChangedEventHandler callback);
