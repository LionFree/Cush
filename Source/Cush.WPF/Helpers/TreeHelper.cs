...
// This class was obtained from Philip Sumi (a WPF Discples blog)
...
namespace Cush.WPF
{
    ...
    public static class TreeHelper
    {
        ...
        public static TParentItem FindVisualParent<TParentItem>(DependencyObject child)
            where TParentItem : DependencyObject
        {
            ...
            // check if the parent matches the type we're looking for
            var parent = parentObject as TParentItem;
            ...
            return FindVisualParent<TParentItem>(parentObject);
        }
