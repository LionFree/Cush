...
namespace Cush.Native.Shell
{
    ...
    {
        [ThreadStatic]
        private static SystemParameters _threadLocalSingleton;
        ...
        public static SystemParameters Current
        {
            get
            {
                if (_threadLocalSingleton == null)
                {
                    _threadLocalSingleton = new SystemParameters();
                }
        ...
        public double WindowCaptionHeight
        {
            ...
            private set
            {
                if (Math.Abs(value - _captionHeight) > double.Epsilon)
                {
