...
namespace Cush.Native.Helpers
{
    internal static class DpiHelper
    {
        ...
        /// </summary>
        /// <param name="physicalPoint">A point in the physical coordinate system.</param>
        /// <returns>Returns the parameter converted to the device independent coordinate system.</returns>
        public static Point DevicePixelsToLogical(Point physicalPoint)
        {
            return _transformToDip.Transform(physicalPoint);
        }
