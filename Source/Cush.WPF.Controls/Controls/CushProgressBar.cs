...
{
    public class CushProgressBar : ProgressBar
    {
        public static readonly DependencyProperty EllipseDiameterProperty =
            DependencyProperty.Register("EllipseDiameter", typeof(double), typeof(CushProgressBar),
                                        new PropertyMetadata(default(double)));

        public static readonly DependencyProperty EllipseOffsetProperty =
            DependencyProperty.Register("EllipseOffset", typeof(double), typeof(CushProgressBar),
                                        new PropertyMetadata(default(double)));

        static CushProgressBar()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(CushProgressBar),
                                                     new FrameworkPropertyMetadata(typeof(CushProgressBar)));

        }

        public CushProgressBar()
        {
