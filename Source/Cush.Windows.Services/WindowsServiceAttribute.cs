...
{
    /// <summary>
    ///     This attribute is used to mark a <see cref="T:WindowsService"/> with configuration and installation attributes.
    /// </summary>
    [AttributeUsage(AttributeTargets.Class)]
    public class WindowsServiceAttribute : Attribute
    {
        /// <summary>
        ///     Marks a WindowsService with configuration and installation attributes.
        /// </summary>
        /// <param name="name">
